...
var (
	...
	ErrorNodePoolLabelClashesWithPipelineLabel      = errors.New("node label name conflicts with Pipeline reserved label name")
	...
	ErrorAlibabaMaxNumberOfNodes                    = errors.New("'max num of nodes' must be greater than min number of nodes but no more than 1000")
	...
	ErrorAksNetworkDnsServiceIpInvalidValue         = errors.New("dnsServiceIp must not end with .1 since it's reserved")
